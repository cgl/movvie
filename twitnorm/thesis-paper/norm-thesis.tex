...
It returns two keys instead, presenting a more valid coverage for some irregularities. % fix and give more detail
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=\linewidth]{fig/lambdaandbeta}
\caption{.}
\label{fig:graph}
\end{center}
\end{figure}
