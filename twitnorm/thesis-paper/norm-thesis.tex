...
% The experiments we ran on this dataset with different minor metric parameters also showed that the dataset is dependent on lexical similarity metrics. The reason behind this bias is the lack of enough contextual information.
