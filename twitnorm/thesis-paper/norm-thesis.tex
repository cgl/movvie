...
\turkcebaslik{Kelime ve Bağlam Bilgisi Temelli Metin Normalizasyonu}
...
\sym{$NL$}{Neighbor List}
\sym{$EL$}{Edge List}
\sym{$T_i$}{Tag of a Word}
\sym{$CL$}{Candidate List}
...
\sym{$\lambda$}{Contextual Similarity Score Parameter}
\sym{$\beta$}{Lexical Similarity Score Parameter}
\sym{ }{}
\end{symbols}
